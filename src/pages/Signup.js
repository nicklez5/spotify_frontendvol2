                        ...
                        <form className={s.addUserForm} onSubmit={handleSignup} >
                            ...
                            <h2 className={s.header_signup}>Sign up</h2>
                                <div className = {s.header_div}>
                                    ...
                                    <input onChange={e => {setEmail(e.target.value)}} type="email" id="email" className={s.header_div_email_input} placeholder="Enter your email"/><br></br>
                                    <label htmlFor="fullName" className={s.header_div_name} >Name: </label>
                                    <input onChange={e => {setFullName(e.target.value)}} type="text" className={s.header_div_name_input} placeholder="Enter your name"/><br></br>
